...
class PostgresWorker():
    ...
    def insert_user(self, data):
      try:
        ...
        vars_query = (data['name'],data['nick_name'], encripted_password ,data['cpf'],data['email'],data['phone_number'],self.date_time_formate,self.date_time_formate)
    ...
    def alter_user(self, data):
      try:
        ...
        verify = self.verify_password_database(result_psw, data['password'])
        ...
        vars_query = (data['name'],data['cpf'],data['email'],data['phone_number'],self.date_time_formate,data['nick_name'])
